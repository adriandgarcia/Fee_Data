...
Here I am looking at the fund families with the lowest and highest overall fees across active products. I start by filtering out index funds and removing fees that are NA (blank) for 2019. 23,351 rows remain.
...
write_csv(Active_Fees,
          "~/Data/Fee_Data/Fee_Data/results/fees_activefunds_firm.csv")
...
write_csv(Active_Summary,
          "~/Data/Fee_Data/Fee_Data/results/fees_activefunds_summary.csv")
...
write_csv(Active_Cat,
          "~/Data/Fee_Data/Fee_Data/results/cat_activefunds_firm.csv")
...
write_csv(Active_Cat_Pct,
          "~/Data/Fee_Data/Fee_Data/results/cat_activefunds_highlow.csv")
...
write_csv(
  ...
  "~/Data/Fee_Data/Fee_Data/results/shareclass_changes_activefunds.csv"
  )
```
...
Here I am looking at the fund families with the lowest and highest overall fees across passive products. I start by filtering out non-index funds and removing fees that are NA (blank) for 2019.
...
write_csv(Passive_Fees,
          "~/Data/Fee_Data/Fee_Data/results/fees_passivefunds_firm.csv")
...
write_csv(Passive_Fees_Past,
          "~/Data/Fee_Data/Fee_Data/results/past_fees_passivefunds_firm.csv")
...
Passive_LowFees_Past %>% 
  select(1:4,
         ...
         5,8) %>%
  write_csv(
          "~/Data/Fee_Data/Fee_Data/results/past_lowfees_passivefunds_firm.csv")
```
...
write_csv(
  ...
  "~/Data/Fee_Data/Fee_Data/results/shareclass_changes_passivefunds.csv"
  )
```
